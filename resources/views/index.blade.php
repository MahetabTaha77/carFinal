...
<div class="hero" style="background-image: url('<?php echo asset("website/images/hero_1_a.jpg") ?>');">
        ...
        <div class="row align-items-center">
            <div class="col-lg-7 text-center order-lg-2">
                <div class="img-wrap-1 mb-5">
                    <img src="{{ asset('website/images/feature_01.png') }}" alt="Image" class="img-fluid">
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="listing d-block  align-items-stretch">
                    <div class="listing-img h-100 mr-4">
                        <img src="{{ asset('images/car/' . $Car->image) }}" alt="Image" class="img-fluid">
                    </div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="testimonial-2">
                    ...
                    <div class="d-flex v-card align-items-center">
                        <img src="{{ asset('images/testimonial/' . $Testimonial->image) }}" alt="Image" class="img-fluid mr-3">
